class Splash {
 ...
 constructor() {
  ...
  this.name = createDiv("Evania Lyu");
  this.name.style('color:white');
  this.name.position(this.splashBorder+20, this.splashBorder+60);
  
  this.info = createDiv("In this project, I created an interactive Snake game with evolving levels and dynamic audio integration. As the player progresses, the game introduces increasing difficulty through obstacle density, fog effects, and adaptive speed. Using real-time input, the snake responds to WASD controls with both slow and fast movement depending on keypress duration. Each level features unique challenges and is accompanied by looping background music that enhances the atmosphere. The game also includes humorous taunt messages during pauses, game over, and victory, adding a playful, character-driven twist to the classic gameplay experience.<a href=<a href=https://editor.p5js.org/Ezii33/sketches/PVCQIu29j>view code</a>");
